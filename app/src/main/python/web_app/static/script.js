document.addEventListener('DOMContentLoaded', () => {
    ...
    downloadBtn.addEventListener('click', async () => {
        ...
        try {
            ...
            window.location.href = `${API_BASE}/api/serve-file?path=${encodeURIComponent(finalData.file)}`;
            
            // Wait a moment and then update text
            setTimeout(() => {
                downloadStatus.textContent = `Sucesso! Arquivo salvo na Galeria do celular.`;
            }, 1000);
